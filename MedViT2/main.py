...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name', type=str, default='MedViT_small', help='Model name to use.')
    #tissuemnist, pathmnist, chestmnist, dermamnist, octmnist, pneumoniamnist, retinamnist, breastmnist, bloodmnist,
    #organamnist, organcmnist, organsmnist'
    parser.add_argument('--dataset', type=str, default='Bone_Binary', help='Dataset to use.')
    ...
    parser.add_argument('--checkpoint_path', type=str, default='./checkpoint/MedViT_small.pth', help='Path to the checkpoint file.')
